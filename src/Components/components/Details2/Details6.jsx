...
const ProductData6 = React.lazy(() => import('../productData/ProductData6'));
...
const Details6 = () => {
    ...
    async function getProducts() {
        try {
            const res = await axios.get('https://dummyjson.com/products/category/mens-watches?limit=1&skip=5');
