...
const ProductData4 = React.lazy(() => import('../productData/ProductData4'));
...
const Details4 = () => {
    ...
    async function getProducts() {
        try {
            const res = await axios.get('https://dummyjson.com/products/category/mens-watches?limit=1&skip=3');
