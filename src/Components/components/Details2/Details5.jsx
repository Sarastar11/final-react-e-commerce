...
const ProductData5 = React.lazy(() => import('../productData/ProductData5'));
...
const Details5 = () => {
    ...
    async function getProducts() {
        try {
            const res = await axios.get('https://dummyjson.com/products/category/mens-watches?limit=1&skip=4');
