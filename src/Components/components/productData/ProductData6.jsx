...
function ProductData6() {
  let [watches, setWatches] = useState([])
  async function getWatches() {
    let res = await axios.get('https://dummyjson.com/products/category/mens-watches?limit=1&skip=5&select=description,dimensions,weight,returnPolicy,meta')
