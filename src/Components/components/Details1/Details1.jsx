...
const ProductData = React.lazy(() => import('../productData/ProductData'));
...
const Details1 = () => {
    ...
    async function getProducts() {
        try {
            const res = await axios.get('https://dummyjson.com/products/category/mens-watches?limit=1&skip=0');
